...
import { ArrayPrototypeFilter, ArrayPrototypeJoin, ArrayPrototypeMap, ArrayPrototypePop, ArrayPrototypePush, ArrayPrototypeSlice, ObjectAssign, SafeSet, StringPrototypeCharAt, StringPrototypeReplace, StringPrototypeSubstring, StringPrototypeToLowerCase, StringPrototypeToUpperCase, } from 'node-primordials';
const types = new SafeSet(['!', '?', '+', '*', '@']);
...
export class AST {
    ...
    toJSON() {
        const ret = this.type === null
            ? ArrayPrototypeMap(ArrayPrototypeSlice(this.#parts), (p) => (typeof p === 'string' ? p : p.toJSON()))
            : [this.type, ...ArrayPrototypeMap(this.#parts, (p) => p.toJSON())];
    ...
    toRegExpSource(allowDot) {
        ...
        if (!this.type) {
            ...
            const src = ArrayPrototypeJoin(ArrayPrototypeMap(this.#parts, (p) => {
    ...
    #partsToRegExp(dot) {
        return ArrayPrototypeJoin(ArrayPrototypeFilter(ArrayPrototypeMap(this.#parts, (p) => {
